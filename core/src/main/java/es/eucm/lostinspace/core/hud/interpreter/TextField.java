 ...
 * pressed. Clipboard functionality is provided via the {@link com.badlogic.gdx.utils.Clipboard} interface. Currently there are two standard
...
public class TextField extends Widget {
	...
	/** Copies the selected contents of this TextField to the {@link com.badlogic.gdx.utils.Clipboard} implementation set on this TextField, then removes
	 * it. */
	public void cut () {
		if (hasSelection) {
			copy();
	 ...
	 * {@link com.badlogic.gdx.Input#setOnscreenKeyboardVisible(boolean)} as appropriate. Might overlap your actual rendering, so use with care!
	 * @author mzechner */
