...
public class ActorTweenAccessor implements TweenAccessor<Actor> {
	...
	public static final int X = 0, Y = 1, ROTATION = 2, SCALE_X = 3, SCALE_Y = 4, ALPHA = 5, COLOR = 6, POSITION = 7, RED = 8,
		GREEN = 9, BLUE = 10, SCALE = 11, DESTRUCTION = 12, TELEPORT = 13, HELP = 14, SCORE = 15;
